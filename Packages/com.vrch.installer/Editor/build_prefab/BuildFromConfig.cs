...
namespace Editor.build_prefab
{
    ...
    {
        // File directories
        public const string GeneratedAssetPath = "Assets/Haptics/Generated/";
        ...
        public static GameObject Build(GameObject aviRoot, Config conf, bool lowPoly)
        {
            ...
            _baseName = "Haptic-Descriptor_" + conf.meta.map_name + "_" + conf.meta.map_author;
        ...
        private static void ScaleConfig(Config conf, GameObject aviRoot, GameObject prefabRoot)
        {
            ...
            if (anim == null) Debug.LogError($"Could not find a {nameof(Animator)} component on Avatar.");
        ...
        /// <summary>
        /// Builds the in-game menu for this prefab and places the generated assets at the given save path.
        /// </summary>
        public static (VRCExpressionsMenu, VRCExpressionParameters) BuildMenu_Static(Config conf, string savePath)
        {
            Utils.CreateDirectoryFromAssetPath(savePath);
            string rootMenuPath = savePath + "Menu_Root.asset";
            string mainMenuPath = savePath + "Menu_Main.asset";
            string parametersPath = savePath + $"Parameters_{conf.meta.map_name}.asset";
